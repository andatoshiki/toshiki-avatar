        ...
        <div className="min-h-full flex flex-col dark:bg-gray-900 dark:text-white">
            ...
            <header className="border-b dark:border-gray-700">
                <div className="container m-auto p-4 max-w-screen-md flex justify-between">
                    <div className="flex items-center space-x-2">
                        <GoLock size="24"/>
                        <span className="text-xl font-bold">toshiki-avatar</span>
                    </div>
                    <ul className="flex items-center space-x-4 font-bold text-blue-500">
                        <li>
                            <Link href="https://github.com/andatoshiki/toshiki-avatar">
            ...
            <footer className="border-t dark:border-gray-700">
                <div className="container m-auto p-4 max-w-screen-md space-y-2">
                    <div>
                        Made with <span className="text-red-500">❤️</span> by <a href="https://toshiki.dev" target="_blank" rel="noreferrer" className="text-blue-500 hover:underline">Anda Toshiki</a> and ☕️ at the pragmatic <a href="https://www.northwestern.edu" target="_blank" rel="noreferrer" className="text-blue-500 hover:underline">Northwestern University</a>.
                    </div>
                </div>
            </footer>
        </div>
